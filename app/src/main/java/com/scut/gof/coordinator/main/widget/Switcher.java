...
public class Switcher extends CustomView {
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        // Set size of view
        setMinimumHeight(DenstityUtil.dp2px(48, getResources()));
        setMinimumWidth(DenstityUtil.dp2px(80, getResources()));
		...
		RelativeLayout.LayoutParams params = new LayoutParams(DenstityUtil.dp2px(20,
				getResources()), DenstityUtil.dp2px(20, getResources()));
			...
			if (event.getAction() == MotionEvent.ACTION_DOWN) {
				...
				if (eventCheck != check) {
					...
					if (onCheckListener != null)
						onCheckListener.onCheck(Switcher.this,check);
				}
				if ((event.getX() <= getWidth() && event.getX() >= 0)) {
					ball.animateCheck();
				}
	...
	protected void onDraw(Canvas canvas) {
		...
		paint.setStrokeWidth(DenstityUtil.dp2px(2, getResources()));
