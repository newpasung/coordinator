...
/**
 * 这个给布局加上包装，以便使用objectanimation，原理未懂,但是会用上这些函数
 */
public class FragContainer extends RelativeLayout {
    private float yFraction = 0;
    private float xFraction = 0;

    public FragContainer(Context context) {
        super(context);
    }

    public FragContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
